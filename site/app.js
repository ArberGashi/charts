const dictionary = {
  ...
  compat_linux_title: { de: "Ubuntu 24.04 LTS", en: "Ubuntu 24.04 LTS" },
  ...
  support_policy_body: {
    de: "Unterstützt wird ArberCharts v2.0.0 (Java 25). Version 1.7.0-LTS bleibt für Bestandskunden verfügbar.",
    en: "ArberCharts v2.0.0 (Java 25) is supported. Version 1.7.0-LTS remains available for existing customers."
  },
  ...
  products_bridges_compose: { de: "Compose Bridge", en: "Compose Bridge" },
  products_bridges_qt: { de: "Qt Bridge (macOS)", en: "Qt Bridge (macOS)" },
  products_bridges_swift: { de: "Swift Bridge (macOS)", en: "Swift Bridge (macOS)" },
  ...
  bridge_compose_title: { de: "Compose Bridge (Deprecated)", en: "Compose bridge (deprecated)" },
  bridge_compose_body: { de: "In v2.0.0 entfernt. Empfohlen: Swing Bridge.", en: "Removed in v2.0.0. Recommended: Swing Bridge." },
  bridge_swift_title: { de: "Swift Bridge (Deprecated)", en: "Swift bridge (deprecated)" },
  bridge_swift_body: { de: "In v2.0.0 entfernt. Empfohlen: Swing Bridge oder Spring Boot Starter.", en: "Removed in v2.0.0. Recommended: Swing Bridge or Spring Boot Starter." },
  bridge_qt_title: { de: "Qt Bridge (Deprecated)", en: "Qt bridge (deprecated)" },
  bridge_qt_body: { de: "In v2.0.0 entfernt. Empfohlen: Swing Bridge.", en: "Removed in v2.0.0. Recommended: Swing Bridge." },
  ...
  pricing_row_updates_dev: { de: "Inklusive (inkl. v1.7.0 LTS & kuenftige Major Releases)", en: "Included (v1.7.0 LTS and future major releases)" },
  pricing_row_updates_startup: { de: "Inklusive (inkl. v1.7.0 LTS & kuenftige Major Releases)", en: "Included (v1.7.0 LTS and future major releases)" },
  pricing_row_updates_pro: { de: "Inklusive (inkl. v1.7.0 LTS & kuenftige Major Releases)", en: "Included (v1.7.0 LTS and future major releases)" },
  pricing_row_updates_enterprise: { de: "Inklusive (inkl. v1.7.0 LTS & kuenftige Major Releases)", en: "Included (v1.7.0 LTS and future major releases)" },
  ...
  pricing_notice_b3: { de: "Wartung: Aktive Lizenznehmer erhalten Zugriff auf alle v1.7.x LTS Updates und Optimierungen.", en: "Maintenance: active licensees receive all v1.7.x LTS updates and optimizations." },
