const dictionary = {
  ...
  hero_subtitle: {
    de: "158 Renderer. Zero-GC Pipeline. Predictive Intelligence (lokal, deterministisch).",
    en: "158 renderers. Zero-GC pipeline. Predictive intelligence (local, deterministic)."
  },
  cta_free: { de: "Starter herunterladen", en: "Download starter" },
  cta_business: { de: "Pricing ansehen", en: "View pricing" },
  cta_contact: { de: "Sales kontaktieren", en: "Contact Sales" },
  compat_kicker: { de: "Kompatibilitaet", en: "Compatibility" },
  compat_title: { de: "Unterstützte Plattformen (v2.0.0)", en: "Supported Platforms (v2.0.0)" },
  compat_body: { de: "ArberCharts v2.0 erfordert Java 25. Fokus auf Swing Desktop und Spring Boot Server.", en: "ArberCharts v2.0 requires Java 25. Focus on Swing Desktop and Spring Boot Server." },
  compat_macos_title: { de: "macOS 15+", en: "macOS 15+" },
  compat_macos_body: { de: "Apple Silicon & Intel. Java 25 JVM.", en: "Apple Silicon & Intel. Java 25 JVM." },
  compat_windows_title: { de: "Windows 11", en: "Windows 11" },
  compat_windows_body: { de: "Java 25 JVM für Desktop/Server.", en: "Java 25 JVM for desktop/server." },
  compat_linux_title: { de: "Ubuntu 24.04", en: "Ubuntu 24.04" },
  compat_linux_body: { de: "Java 25 JVM auf glibc 2.39+.", en: "Java 25 JVM on glibc 2.39+." },
  quickstart_kicker: { de: "Quick Start", en: "Quick start" },
  quickstart_title: { de: "Fluent API mit ArberChartBuilder", en: "Fluent API with ArberChartBuilder" },
  quickstart_body: { de: "Beispiel fuer einen minimalen Chart-Panel-Aufbau (JVM).", en: "Example of a minimal chart panel setup (JVM)." },
  download_core: { de: "Starter JAR herunterladen", en: "Download Starter JAR" },
  ...
  docs_bridge_body: { de: "Plattform-Bridges für Swing und Server.", en: "Platform bridges for Swing and server." },
  docs_swing_cta: { de: "Swing JavaDocs", en: "Swing JavaDocs" },
  docs_server_cta: { de: "Server JavaDocs", en: "Server JavaDocs" },
  docs_compose_cta: { de: "Bridge Status", en: "Compose docs" },
  docs_swift_cta: { de: "Bridge Status", en: "Swift docs" },
  docs_qt_cta: { de: "Bridge Status", en: "Qt docs" },
  support_policy_title: { de: "Version Policy", en: "Version policy" },
  support_policy_body: {
    de: "Unterstützt wird ausschließlich ArberCharts v2.0.0 (Java 25).",
    en: "Only ArberCharts v2.0.0 (Java 25) is supported."
  },
  ...
  products_subtitle: { de: "v2.0.0 — Starter-Framework für geschäftskritische Java 25 Applikationen.", en: "v2.0.0 — Starter framework for mission-critical Java 25 applications." },
  products_core_title: { de: "Starter Framework", en: "Starter framework" },
  ...
  products_core_cta: { de: "Starter JAR", en: "Starter JAR" },
  products_demo_title: { de: "Showcase UI (intern)", en: "Showcase UI (internal)" },
  products_demo_body: { de: "Demo- und Showcase-Ansichten sind aktuell nur auf Anfrage verfuegbar.", en: "Demo and showcase views are currently available on request only." },
  products_demo_b1: { de: "Renderer-Demos fuer Financial und Medical.", en: "Renderer demos for financial and medical." },
  products_demo_b2: { de: "Best-Practice Layouts und Interaktionen.", en: "Best-practice layouts and interactions." },
  products_demo_b3: { de: "Kontakt fuer Zugriff und Evaluierung.", en: "Contact us for access and evaluation." },
  products_demo_cta: { de: "Kontakt aufnehmen", en: "Contact us" },
  products_bridges_kicker: { de: "Bridges", en: "Bridges" },
  products_bridges_title: { de: "Bridge-Downloads", en: "Bridge downloads" },
  products_bridges_body: { de: "Compose, Qt und Swift werden als separate Artefakte ausgeliefert.", en: "Compose, Qt, and Swift ship as separate artifacts." },
  products_bridges_compose: { de: "Removed Bridge", en: "Removed Bridge" },
  products_bridges_qt: { de: "Removed Bridge", en: "Removed Bridge" },
  products_bridges_swift: { de: "Removed Bridge", en: "Removed Bridge" },
  products_bridges_note: { de: "Qt/Swift: nur macOS arm64. Compose: JVM Desktop.", en: "Qt/Swift: macOS arm64 only. Compose: JVM desktop." },
  products_kicker: { de: "Produkte", en: "Products" },
  product_kicker: { de: "Produkt", en: "Product" },
  product_title: { de: "ArberCharts Starter Framework", en: "ArberCharts Starter Framework" },
  product_subtitle: {
  ...
  product_downloads_body: {
    de: "Stellen Sie Entwicklern das Starter-Paket zur Verfuegung. Demo-Showcase auf Anfrage.",
    en: "Provide the starter bundle to developers. Demo showcase on request."
  },
  ...
  portfolio_core: { de: "Starter-Bundle fuer Java-Entwickler.", en: "Starter bundle for Java developers." },
  portfolio_demo_title: { de: "Showcase UI", en: "Showcase UI" },
  portfolio_demo_body: { de: "Showcase auf Anfrage fuer Evaluation und Review.", en: "Showcase available on request for evaluation and review." },
  portfolio_demo_link: { de: "Zugriff anfragen", en: "Request access" },
  demo_kicker: { de: "Showcase UI", en: "Showcase UI" },
  demo_title: { de: "Ein Premium-Showcase für Entscheider.", en: "A premium showcase for decision makers." },
  demo_subtitle: {
    de: "Erleben Sie ArberCharts v2.0.0 in Aktion. 158 Renderer, Zero-GC 60 FPS Rendering und industrielle Präzision mit Java 25.",
    en: "Experience ArberCharts v2.0.0 live. 158 renderers, Zero-GC 60 FPS rendering, and industrial precision with Java 25."
  },
  demo_download: { de: "Demo anfragen", en: "Request demo" },
  demo_downloads_title: { de: "Verfuegbarkeit", en: "Availability" },
  demo_downloads_body: { de: "Die Demo ist aktuell nicht oeffentlich verfuegbar. Bitte kontaktieren Sie uns fuer Zugriff.", en: "The demo is not publicly available at the moment. Please contact us for access." },
  demo_downloads_jar_body: { de: "Auf Anfrage fuer evaluierte Kunden.", en: "Available on request for vetted customers." },
  ...
  demo_gallery_title: { de: "Showcase Screens", en: "Showcase screens" },
  demo_gallery_body: { de: "Ausgewaehlte Showcase-Ansichten (auf Anfrage).", en: "Selected showcase views (available on request)." },
  ...
  products_highlight_ui_body: { de: "Neu in v2.0.0: FlatLaf Integration mit HiDPI Retina Support.", en: "New in v2.0.0: FlatLaf integration with HiDPI Retina support." },
  products_highlight_predict_title: { de: "Predictive Intelligence", en: "Predictive intelligence" },
  products_highlight_predict_body: { de: "Lokale, deterministische Vorhersagen und Anomalie-Indikatoren ohne Cloud-Abhaengigkeit.", en: "Local, deterministic forecasts and anomaly indicators without cloud dependency." },
  ...
  products_stack_step1_body: { de: "Starter JAR einbinden und Version pinnen.", en: "Use the starter JAR and pin the version." },
  ...
  products_docs_title: { de: "JavaDocs (v2.0.0)", en: "JavaDocs (v2.0.0)" },
  ...
  products_docs_compose_cta: { de: "Removed Bridge Docs", en: "API docs" },
  products_docs_swift_cta: { de: "API Docs", en: "API docs" },
  products_docs_qt_cta: { de: "API Docs", en: "API docs" },
  products_support_policy_title: { de: "Support-Policy v2.0.0", en: "v2.0.0 support policy" },
  products_support_policy_body: {
    de: "ArberCharts v2.0.0 erfordert Java 25. Neue Projekte sollten v2.0.0 verwenden.",
    en: "ArberCharts v2.0.0 requires Java 25. New projects should use v2.0.0."
  },
  solutions_title: { de: "Solutions & Integration", en: "Solutions & integration" },
  solutions_subtitle: { de: "v2.0.0 — Zertifizierte Use-cases und industrielle Integration für geschäftskritische Systeme.", en: "v2.0.0 — Certified use cases and industrial integration for mission-critical systems." },
  solutions_predictive_note: { de: "Predictive Intelligence (lokal, deterministisch) fuer Vorhersagen und Anomalie-Tracking.", en: "Predictive intelligence (local, deterministic) for forecasting and anomaly tracking." },
  ...
  solutions_medical_b1: { de: "Sweep-Erase EKG/EEG mit Zero-GC Data-Safety (v2.0.0).", en: "Sweep-erase ECG/EEG with Zero-GC data safety (v2.0.0)." },
  ...
  solutions_stream_body: { de: "Dank v2.0.0 Zero-GC bleibt die UI auch bei 1000 Hz Datenrate stabil.", en: "Thanks to v2.0.0 Zero-GC, the UI stays stable even at 1000 Hz data rates." },
  ...
  solutions_download_title: { de: "Download Starter", en: "Download starter" },
  solutions_download_body: { de: "Starter Bundle für Entwickler und Integrationsteams.", en: "Starter bundle for developers and integration teams." },
  solutions_download_cta: { de: "ArberCharts Starter v2.0.0 herunterladen", en: "Download ArberCharts Starter v2.0.0" },
  ...
  tech_docs_compose_cta: { de: "Removed Bridge Docs", en: "API docs" },
  tech_docs_swift_cta: { de: "API Docs", en: "API docs" },
  tech_docs_qt_cta: { de: "API Docs", en: "API docs" },
  bridge_compose_title: { de: "Bridge status", en: "Bridge status" },
  bridge_compose_body: { de: "Nicht verfügbar in der aktiven Produktlinie.", en: "Not available in the active product line." },
  bridge_swift_title: { de: "Bridge-Status", en: "Bridge status" },
  bridge_swift_body: { de: "Nicht verfügbar in der aktiven Produktlinie.", en: "Not available in the active product line." },
  bridge_qt_title: { de: "Bridge-Status", en: "Bridge status" },
  bridge_qt_body: { de: "Nicht verfügbar in der aktiven Produktlinie.", en: "Not available in the active product line." },
  bridge_docs_body: { de: "Siehe User Guide fuer Nutzungsmuster und API-Verträge.", en: "See the User Guide for usage patterns and API contracts." },
  ...
  pricing_subtitle: {
    de: "v2.0.0 — Industrielle Präzision für jedes Team. Kostenlos für Einzelentwickler & Forschung.",
    en: "v2.0.0 — industrial precision for every team. Free for individual developers and research."
  },
  ...
  pricing_row_updates_dev: { de: "Inklusive (v2.x Updates)", en: "Included (v2.x updates)" },
  pricing_row_updates_startup: { de: "Inklusive (v2.x Updates)", en: "Included (v2.x updates)" },
  pricing_row_updates_pro: { de: "Inklusive (v2.x Updates)", en: "Included (v2.x updates)" },
