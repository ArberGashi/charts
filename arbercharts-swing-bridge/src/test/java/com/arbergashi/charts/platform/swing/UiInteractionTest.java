...
public class UiInteractionTest {
    ...
    public void wheelZoomAdjustsRange() {
        ...
        double widthBefore = before.getMaxX() - before.getMinX();
        ...
        double widthAfter = after.getMaxX() - after.getMinX();
    ...
    public void dragPanShiftsRange() {
        ...
        PlotContext before = panel.getDebugContext();
        double beforeMin = before.getMinX();
        double beforeMax = before.getMaxX();
        ...
        PlotContext after = panel.getDebugContext();
        double afterMin = after.getMinX();
        double afterMax = after.getMaxX();
    ...
    public void autoScaleHandlesZeroRangeY() {
        ...
        assertNotEquals(ctx.getMinY(), ctx.getMaxY());
    }
}
