...
class DockedLegendSizePolicyTest {
    ...
    void compactDefaultsAreSideAware() {
        ...
        DockedLegendPanel right = new DockedLegendPanel(context(), ChartThemes.getDarkTheme());
        right.setDockSide(LegendDockSide.RIGHT);
        Dimension prefRight = right.getPreferredSize();

        DockedLegendPanel top = new DockedLegendPanel(context(), ChartThemes.getDarkTheme());
    ...
    void denseDefaultsAreLargerThanCompact() {
        ChartAssets.setProperty("Chart.legend.dock.density", "compact");
        DockedLegendPanel compact = new DockedLegendPanel(context(), ChartThemes.getDarkTheme());
        ...
        DockedLegendPanel dense = new DockedLegendPanel(context(), ChartThemes.getDarkTheme());
    ...
    void propertiesOverrideDefaults() {
        ...
        DockedLegendPanel p = new DockedLegendPanel(context(), ChartThemes.getDarkTheme());
