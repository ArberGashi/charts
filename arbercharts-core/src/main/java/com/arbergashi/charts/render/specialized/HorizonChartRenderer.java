...
public class HorizonChartRenderer extends BaseRenderer {
    ...
    protected void drawData(ArberCanvas canvas, ChartModel model, PlotContext context) {
        ...
        ArberColor[] pos = (ArberColor[]) RendererAllocationCache.getArray(this, "horizon.legacy.pos", ArberColor.class, MAX_BANDS);
        ArberColor[] neg = (ArberColor[]) RendererAllocationCache.getArray(this, "horizon.legacy.neg", ArberColor.class, MAX_BANDS);
        ...
        float[] rect = RendererAllocationCache.getFloatArray(this, "horizon.legacy.rect", 4);
