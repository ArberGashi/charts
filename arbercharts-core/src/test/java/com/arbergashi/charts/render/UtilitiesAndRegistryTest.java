...
public class UtilitiesAndRegistryTest {
    ...
    public void chartUtilsAndRegistrySanity() {
        ...
        double w1 = com.arbergashi.charts.util.ChartUtils.calculateBestBarWidth(10, 200.0, 0.2f);
        double w2 = com.arbergashi.charts.util.ChartUtils.calculateBestBarWidth(5, 200.0, 0.2f);
        assertTrue(w1 >= 1.0);
        assertTrue(w2 > w1);
        ...
        assertTrue(ctx.plotBounds().contains(dest));
